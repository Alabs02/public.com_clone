...
const FooterText = () => {
  return (
    <Fragment>
      <div className="text-xs text-justify md:ext-left mt-12">
        &copy; Copyright {new Date().getFullYear()} Public Holdings, Inc. All Rights Reserved.
      </div>
      <section className="text-xs text-justify md:ext-left my-4">
      ...
      <section className="my-4 text-xs text-justify md:ext-left">
      ...
      <section className="mt-4 mb-22 text-xs text-justify md:ext-left">
